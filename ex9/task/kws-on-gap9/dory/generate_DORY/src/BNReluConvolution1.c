...
void __attribute__ ((noinline)) BNReluConvolution1(void *args) {
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 7680 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 7688, l1_buffer + 7688 + 7360 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 15056, l1_buffer + 15056 + 1088 },
    .index = 0
  };
  ...
  void * im2col = l1_buffer + 16168;
  void * pwt_buffer = im2col + 624;
