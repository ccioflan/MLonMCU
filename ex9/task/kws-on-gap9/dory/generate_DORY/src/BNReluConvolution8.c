...
void __attribute__ ((noinline)) BNReluConvolution8(void *args) {
  //////////////////////////////////////////////////////////////////////////
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 6400 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 6408, l1_buffer + 6408 + 6400 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 12816, l1_buffer + 12816 + 4608 },
    .index = 0
  };
