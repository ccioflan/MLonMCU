...
static void kernel(Layer tile, void * im2col, void * pwt_buffer) {
    pulp_nn_conv_Ho_parallel(
      ...
      3, 3,
      tile.padding.top, tile.padding.bottom, tile.padding.left, tile.padding.right, 2, 2,
      1, 1
      );
}
...
void __attribute__ ((noinline)) BNReluConvolution0(void *args) {
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 490 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 498, l1_buffer + 498 + 7680 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 8186, l1_buffer + 8186 + 1088 },
    .index = 0
  };
