...
void __attribute__ ((noinline)) BNReluConvolution5(void *args) {
  //////////////////////////////////////////////////////////////////////////
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 7040 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 7048, l1_buffer + 7048 + 6720 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 13776, l1_buffer + 13776 + 1088 },
    .index = 0
  };
  ...
  void * im2col = l1_buffer + 14888;
  void * pwt_buffer = im2col + 576;
