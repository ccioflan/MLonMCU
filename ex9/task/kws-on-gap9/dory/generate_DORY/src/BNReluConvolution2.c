...
void __attribute__ ((noinline)) BNReluConvolution2(void *args) {
  //////////////////////////////////////////////////////////////////////////
  ...
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 7368, l1_buffer + 7368 + 7360 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 14736, l1_buffer + 14736 + 4608 },
    .index = 0
  };
