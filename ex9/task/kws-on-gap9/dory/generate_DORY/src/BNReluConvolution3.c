...
void __attribute__ ((noinline)) BNReluConvolution3(void *args) {
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 7360 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 7368, l1_buffer + 7368 + 7040 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 14416, l1_buffer + 14416 + 1088 },
    .index = 0
  };
  ...
  void * im2col = l1_buffer + 15528;
  void * pwt_buffer = im2col + 600;
