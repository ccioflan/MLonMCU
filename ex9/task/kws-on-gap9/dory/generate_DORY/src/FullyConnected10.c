...
void __attribute__ ((noinline)) FullyConnected10(void *args) {
  //////////////////////////////////////////////////////////////////////////
  ...
  const Layer layer = {
    .addr = {
      ...
      .bias = layer_args->L2_weights + 768,
  ...
  DoubleBuffer db_input = {
    .addrs = { l1_buffer + 0, l1_buffer + 0 + 64 },
    .index = 0
  };
  DoubleBuffer db_output = {
    .addrs = { l1_buffer + 72, l1_buffer + 72 + 48 },
    .index = 0
  };
  DoubleBuffer db_weights = {
    .addrs = { l1_buffer + 128, l1_buffer + 128 + 768 },
    .index = 0
  };
  ...
  for(int iter=0; iter < total_tiles; iter++) {
    Address addr = {
      ...
      .bias = l1_buffer + 920 + index.output_channel * 48,
